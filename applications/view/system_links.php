    ...
    <div class="pc-container">
      <div class="pc-content">
        ...
        <div class="row ">
            <div class="col-xl-12">
              <!---<a href="form.php"> --->
            <button  class="btn btn-primary btn-sm"  id="addLink" ><i class="bi bi-plus-circle-fill" style="margin-right: 10px;"></i>Add category</button> 
...
<!---- resgitration Model --->
       ...
       <div class="modal-dialog   " role="document">
        ...
        <h5 class="modal-title">System_links Registration</h5>
