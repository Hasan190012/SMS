    ...
    <div class="pc-container">
      <div class="pc-content">
        ...
        <div class="row ">
            <div class="col-xl-12">
              <!---<a href="form.php"> --->
            <button  class="btn btn-primary btn-sm"  id="addCategory" ><i class="bi bi-plus-circle-fill" style="margin-right: 10px;"></i>Add category</button> 
...
<!---- resgitration Model --->
  ...
  A simple danger alert—check it out!
        ...
        <div class="form-group">
        <label >icon</label>
        <input type="tex" name="" id="icon" class="form-control">
        </div>
        </div>
        ...
        <option value="">Select the Role</option>
          ...
          <option value="studentCenter">studentCenter</option>
