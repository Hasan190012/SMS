    ...
    <div class="pc-container">
      <div class="pc-content">
        ...
        <div class="row ">
            <div class="col-xl-12">
              <!---<a href="form.php"> --->
            <button  class="btn btn-primary btn-sm "  id="addNew" ><i class="bi bi-plus-circle-fill" style="margin-right: 10px;"></i>Add New User</button> 
            
            </a>   
                  
                <table class="table  table-sm  fst-normal"  style="margin-top: 5px;" id="userTable" >
