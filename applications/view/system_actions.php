    ...
    <div class="pc-container">
      <div class="pc-content">
        ...
        <div class="row ">
            <div class="col-xl-12">
              <!---<a href="form.php"> --->
            <button  class="btn btn-primary btn-sm"  id="addAction" ><i class="bi bi-plus-circle-fill" style="margin-right: 10px;"></i>Add action</button> 
...
<!---- resgitration Model --->
       ...
       <div class="modal-dialog   " role="document">
        ...
        <h5 class="modal-title">System_actions Registration</h5>
  ...
  A simple danger alert—check it out!
        ...
        <div class="form-group">
        <label >action</label>
        <input type="text" name="" id="system_action" class="form-control">
        </div>
        </div>
